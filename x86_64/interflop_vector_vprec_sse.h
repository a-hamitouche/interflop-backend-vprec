...
#ifndef __INTERFLOP_VECTOR_VPREC_SSE_H__
#define __INTERFLOP_VECTOR_VPREC_SSE_H__


#define INTERFLOP_VECTOR_VPREC_API(name) interflop_vector_vprec_##name##_##sse
